...
# Plotly template matching the design system
...
if uploaded_file is not None:
    raw_df, warnings = _load(uploaded_file)
    st.sidebar.success(f"Loaded {len(raw_df):,} customer records.")
else:
    raw_df, warnings = _load(DEFAULT_DATA_PATH)
...
# ---------------------------------------------------------------------------
# Tab 5: What-If Churn Risk Simulator
# ---------------------------------------------------------------------------
